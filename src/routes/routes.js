...
import ModuleCards from '../pages/dashboard/index';
// import HelpPage from "./view/module/help";
// import Discovery from "./view/module/discovery";
...
const routes = [
  { path: "/dashboard", name: "Module Cards", element: ModuleCards },
